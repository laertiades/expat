...
module Expat
  class Application < Rails::Application
    ...
    config.middleware.insert 0, 'Rack::Rewrite' do
      ...
      r302      '/corporate-governance.jpg',   'http://www.expattaxpreparers.com/corporate-governance.jpg'
      ...
      r301      '/Credit%20Card%20Form.xls',   'http://d21c7j241p6103.cloudfront.net/questionnaires/CreditCard.xls'
      r302      %r{/(_derived/.+)},            'http://www.expattaxpreparers.com/$1'
      r301      %r{/(\d+)%20US%20Tax%20Questionnaire\.xlsx},          'http://d21c7j241p6103.cloudfront.net/questionnaires/$1.xlsx'
      r301      %r{/(\d+)%20US%20Tax%20Questionnaire\.xls},           'http://d21c7j241p6103.cloudfront.net/questionnaires/$1.xls'
      r301      %r{/(\d+)%20US%20Tax%20Organizer\.xls},               'http://d21c7j241p6103.cloudfront.net/questionnaires/$1.xls'
      r301      %r{/(\d+)%20New%20US%20Tax%20Questionnaire%201\.xls}, 'http://d21c7j241p6103.cloudfront.net/questionnaires/$1.xls'
    end
  end
end
